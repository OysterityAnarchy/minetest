	...
	const ParticleSpawnerParameters &p, u16 attached_id, u32 id)
{
	...
	if (peer_id == PEER_ID_INEXISTENT) {
		 ...
		 ** MODIFICATION for oysterity: don't send particles to distant players at all
			 line below originally said const bool distance_check = !attached_id && p.time <= 1.0f && p.time != 0.0f;
